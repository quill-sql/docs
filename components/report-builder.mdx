...
pre-existing dashboard item. This might be useful if you want to allow your end
...
<ParamField path='onSubmitCreateReport' type='(item: DashboardItem) => void'>
	A callback function that will trigger when a new chart is saved.
</ParamField>

<ParamField path='onSubmitEditReport' type='(item: DashboardItem) => void'>
