...
<iframe
	src='https://5wp4n7-5173.csb.app/chart-editor'
	style={{
		width: "calc(100% + 124px)",
		marginLeft: -44,
		height: 900,
	}}
	title='ChartEditor Component'
...
<Tabs>
  ...
  [![Edit [Ant Design] Quill React Components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/p/devbox/ant-design-quill-react-components-9qcs8k?embed=1)
    <iframe
	src='https://5wp4n7-5173.csb.app/chart-editor/ant'
	style={{
		width: "100%",
		height: 800,
	}}
...
```
  ...
  [![Edit [Material Design] Quill React Components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/p/devbox/material-design-quill-react-components-d862dk?embed=1)
    <iframe
	src='https://5wp4n7-5173.csb.app/chart-editor/material'
	style={{
		width: "100%",
		height: 800,
	}}
...
```
  ...
  [![Edit Quill React Components](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/p/devbox/sad-cdn-y1nb3m?embed=1)
    <iframe
	src='https://5wp4n7-5173.csb.app/chart-editor/shadcn'
	style={{
		width: "100%",
		height: 800,
	}}
...
export function ShadcnChartEditor() {
	return (
		<ChartEditor
			isOpen={true}
			setIsOpen={() => null}
