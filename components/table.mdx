...
export function ShadcnTable() {
	return <Table chartId='6644088e6e2470000cbdb109' />;
}
```
...
If you know the id of the table you would like to display, you can pass in the chartId to the Table component and it will load and display the data for that table.
...
function App() {
	return (
		<QuillProvider organizationId='2' publicKey='6579031b3e41c378aa8180ec'>
			<Table chartId='664283fb4db8ad000bfe54d7' />
		</QuillProvider>
	);
}
```
