...
<Tabs>
	<Tab title='Line Chart'>
		<iframe
			src='https://5wp4n7-5173.csb.app/chart/line'
			style={{
				width: "100%",
				height: 300,
				marginLeft: -20,
	...
	<Tab title='Bar Chart'>
		<iframe
			src='https://5wp4n7-5173.csb.app/chart/bar'
			style={{
				width: "100%",
				height: 300,
				marginLeft: -20,
	...
	<Tab title='Pie Chart'>
		<iframe
			src='https://5wp4n7-5173.csb.app/chart/pie'
			style={{
				width: "100%",
				height: 300,
				marginLeft: -20,
	...
	<Tab title='Bar List'>
		<iframe
			src='https://5wp4n7-5173.csb.app/chart/list'
			style={{
				width: "100%",
				height: 300,
				marginLeft: -20,
	...
	<Tab title='Metric'>
		<iframe
			src='https://5wp4n7-5173.csb.app/chart/metric'
			style={{
				width: "100%",
				height: 300,
				marginLeft: -20,
	...
	<Tab title='Table'>
		<iframe
			src='https://5wp4n7-5173.csb.app/chart/table'
			style={{
				width: "100%",
				height: 300,
				marginLeft: -20,
...
If you know the id of the chart you would like to display, you can pass in the chartId to the Chart component and it will load and display the data for that chart.
...
Alternatively, if you have the actual data you would like to display (eg. you fetched the data using our `useQuill` hook) you can also pass in a `DashboardItem` directly to the Chart component and it will display that data without async fetching.
