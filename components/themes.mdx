...
<ResponseField name='primaryTextColor' type='string' required>
	The font family you want Quill to use. This is usually the same primary font
...
<ResponseField name='chartLabelColor' type='string' required>
	The font family you want Quill to use. This is usually the same as or similar
	to the secondary font your app uses. ex: "#666666"
</ResponseField>
<ResponseField name='chartTickColor' type='string' required>
	The font family you want Quill to use. This is usually the same as or similar
	to the secondary font your app uses. ex: "#CCCCCC"
</ResponseField>
