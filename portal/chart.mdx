...
description: "Build your first chart in less than a minute"
---
...
Once you are satisfied with your query and the query results, click `Add to dashboard` in the bottom right to turn the query into a dashboard item.
...
Here, you can edit the name of the chart, the dashboard this chart should belong to, the chart type, and much more. When used in an embedded flow where the dashboard is known ahead of time, developers can pre-select this dashboard and the option will be hidden in this form.
