...
Go to [app.quill.co/onboard](https://app.quill.co/onboard) and enter the read-only database connection string that we created in the last step.

<Tip>
	Make sure to add the quill server to your database IP whitelist, if you have
	one. Requests from Quill will always come from `34.133.137.225`.
</Tip>
