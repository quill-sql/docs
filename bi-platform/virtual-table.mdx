---
title: "Create a view"
description: "Add a SQL view with Quill in less than a minute"
---
...
<CardGroup cols={3}>
	<Card
		...
		icon='square-1'
		href={"/portal/dashboard"}></Card>
	<Card title='Add a chart' icon='square-2' href={"/portal/chart"}></Card>
	<Card title='Add a view' icon='square-3' href={"/portal/view"}></Card>
</CardGroup>
