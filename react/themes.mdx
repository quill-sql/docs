...
// You can pass a custom theme to be applied to the default Quill
...
<ResponseField name='hoverPrimaryButtonColor' type='string'>
...
<ResponseField name='fontSizeSmall' type='number'>
	Optional small font size token.
</ResponseField>
<ResponseField name='fontSizeMedium' type='number'>
	Optional medium font size token.
</ResponseField>
<ResponseField name='fontWeightMedium' type='number'>
	Optional medium font-weight token.
</ResponseField>
<ResponseField name='fontWeightBold' type='number'>
	Optional bold font-weight token.
</ResponseField>
<ResponseField name='hoverTextColor' type='string'>
	Text color to use for hovered text states.
</ResponseField>
<ResponseField name='hoverPrimaryButtonTextColor' type='string'>
	Text color for primary buttons on hover.
</ResponseField>
<ResponseField name='barChartCornerRadius' type='number'>
	Optional fixed corner radius for bar charts.
</ResponseField>
<ResponseField name='barChartCornerRadiusRatio' type='number'>
	Optional corner-radius ratio applied to bar charts.
</ResponseField>
