...
function CustomDashboard() {
  ...
  const chartsSection = sections ? sections["charts"] : []

  if (chartsSection){
    return (
      <>
        <ChartsSection reports={chartsSection} />
      </>
    );
  }
  return (
...
function ChartCard({ reportId, name }: { reportId: string, name: string}) {
...
<ParamField body="config" type="object">
  ...
  <Expandable title="config properties">
    ...
    <ResponseField name="cacheEnabled" type="boolean" default={false}>
      Enable dashboard report caching.
    </ResponseField>
    <ResponseField name="cacheType" type="'memory' | 'idb'">
      Cache storage type when caching is enabled.
    </ResponseField>
    <ResponseField name="showCacheLogs" type="boolean" default={false}>
      Whether to log cache stats to the console.
    </ResponseField>
  </Expandable>
</ParamField>
...
<ParamField body="lastUpdated" type="number">
  Epoch timestamp of the last dashboard report fetch/update.
</ParamField>

<ParamField body="forceCacheRefresh" type="() => void">
  Forces a cache refresh when caching is enabled.
</ParamField>
